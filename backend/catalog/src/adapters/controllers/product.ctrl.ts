...
import {
  CreateProductDimensionInput,
  CreateProductInput,
} from '../../application/use-cases/product/create-product/create-product.dto';
...
export default class ProductController {
  constructor(
    ...
    httpServer.on('get', '/product/:nameProduct', async (params: any) => {
      return getProduct.execute(params.nameProduct);
    });

    httpServer.on('get', '/products', async () => {
